...
public class ClaimController {
    ...
    public ResponseEntity<UUID> createClaimTest(@RequestBody ClaimCreateRequestDTO request) throws ClientNotFoundException, StatusTypeNotFoundException, ClaimTypeNotFoundException, PolicyClaimCoverageNotEnoughException {
        UUID claimId = claimService.createClaimTest(request);
        return new ResponseEntity<>(claimId, HttpStatus.CREATED);
    }
