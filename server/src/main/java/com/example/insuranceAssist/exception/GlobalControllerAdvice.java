...
public class GlobalControllerAdvice {
    ...
    // Handle InvalidDateOfBirthException
    @ExceptionHandler(InvalidDateOfBirthException.class)
    public ResponseEntity<Map<String, Object>> handleInvalidDateOfBirth(InvalidDateOfBirthException ex){
        return buildErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST);
    }
    ...
    // Handle InvalidPhoneNumberException
