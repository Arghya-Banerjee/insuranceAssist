...
public class ClaimMaster {
    ...
    public ClaimMaster(PolicyMaster policy, ClaimTypeMaster claimType, UserMaster agent, UserMaster client, long claimAmount, StatusTypeMaster status, LocalDateTime openDate, LocalDateTime closingDate, String procedureNotes, LocalDateTime updatedAt) {
        this.policy = policy;
